...
#@file:importRainbowWhiteList.sh
#@author:dongying
#@version:1.0.0.0
#@brief:import rainbow whitelist to database
...
CONF_SH=../conf/importRainbowWhiteList.conf
[ -f "${CONF_SH}" ] && source $CONF_SH || echo "not exist ${CONF_SH} "
...
program=importRainbowWhiteList.sh

LOG_FILE=${LOG_PATH}/importRainbowWhiteList.log
