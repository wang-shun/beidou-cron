...
public interface AmDriver {
	 ...
	 * @date Jul 1, 2013
	 */
	List<GrantResult> grantAuthorityByTextList(List<Text> list, Integer appId, Boolean onlyMedias);
	 ...
	 * @date Jul 1, 2013
	 */
	GrantResult grantAuthority(String descJson, Long tpId, Integer appId, Boolean onlyMedias);
	 ...
	 * @date Jul 1, 2013
	 */
	byte[] downloadSwf(String descJson, Long tpId);
