...
public class UnitDrmcMaterView {
	...
	private Integer drmcsyncflag = CproUnitConstant.DRMC_SYNC_FLAG_NO;
	...
	public Integer getDrmcsyncflag() {
		return drmcsyncflag;
	}

	public void setDrmcsyncflag(Integer drmcsyncflag) {
		this.drmcsyncflag = drmcsyncflag;
	}
	...
	public String toString() {
		...
		buffer.append("drmcsyncflag").append("='").append(getDrmcsyncflag()).append("' ");
		buffer.append("]");
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UnitDrmcMaterView))
			return false;
		UnitDrmcMaterView castOther = (UnitDrmcMaterView) other;
