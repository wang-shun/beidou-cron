 ...
 * @date Apr 23, 2013
 */
public interface UbmcDriverProxy {
	 ...
	 *			}
	 */
	public RpcBatchResponse insert(List<Text> texts, Map<String, String> params);
	 ...
	 * 			}
	 */
	public RpcBatchResponse update(List<Text> texts, Boolean mediaDelDelay, Map<String, String> params);
	 ...
	 */
	public RpcBatchResponse remove(List<Text> texts, Boolean isDelayed, Map<String, String> params);
	 ...
	 *			}
	 */
	public RpcBatchResponse copy(List<Text> texts, Map<String, String> params);
	 ...
	 * 			}
	 */
	public RpcBatchResponse get(List<Text> texts, Boolean isPreview, Map<String, String> params);
	 ...
	 * 			}
	 */
	public RpcBatchResponse addVersion(List<Text> texts, Map<String, String> params);
	...
	public RpcResponse getVersions(Long mcId, Boolean filterNoAuth, Integer startId, 
			Integer endId, Integer num, Boolean isPreview, Map<String, String> params);
	...
	public RpcBatchResponse getMedia(List<Long> mediaIds, Integer urlStrategy,
			Map<String, String> strategyAtt, Boolean withContent, Map<String, String> params);
	 ...
	 * 			}
	 */
	public RpcBatchResponse lock(List<Text> texts, Map<String, String> params);
	 ...
	 */
	public RpcBatchResponse unlock(List<Text> texts, Map<String, String> params);
     ...
     *  }
     */
    public RpcBatchResponse manageBlockStatus(List<Long> mediaIds, boolean isBlocking, Map<String, String> params);
     ...
     * }
     */
    public RpcResponse getRelatedText(Long mediaId, Map<String, String> params);
}
