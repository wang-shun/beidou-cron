...
/**
 * ClassName: AkaPatrolUnitCheckInfoTransformer
 * Function: 为aka轮询创意使用
 *
 * @author <a href="mailto:genglei01@baidu.com">耿磊</a>
 * @version 
 * @since beidou-cron1.1.2
 * @date Jul 21, 2011
 * @see 
 */
public class AkaPatrolUnitCheckInfoTransformer implements Transformer {
