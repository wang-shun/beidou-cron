...
import com.baidu.beidou.util.net.NetBytesSwitch;
import com.baidu.beidou.util.net.UnsignedSwitch;
...
public abstract class NsHead {
	 ...
	 * 2009-3-14
	 */
	public byte[] toBytes() throws InternalException{
		...
		try {
			...
			throw new InternalException("exception when putting bytes for nshead...", e);
		}
