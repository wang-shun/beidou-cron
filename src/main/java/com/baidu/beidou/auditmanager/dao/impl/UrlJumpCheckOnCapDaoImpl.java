/**
 * beidou-cron-trunk#com.baidu.beidou.auditmanager.dao.impl.UrlJumpCheckOnCapDaoImpl.java
 * 上午12:36:47 created by kanghongwei
 */
...
public class UrlJumpCheckOnCapDaoImpl extends GenericDaoImpl implements UrlJumpCheckOnCapDao {
	
	private static final Log log = LogFactory.getLog(UrlJumpCheckOnCapDaoImpl.class);
