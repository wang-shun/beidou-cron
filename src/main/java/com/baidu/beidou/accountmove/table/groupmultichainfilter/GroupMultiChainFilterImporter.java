package com.baidu.beidou.accountmove.table.groupmultichainfilter;
...
public class GroupMultiChainFilterImporter implements TableImporter{
...
//	private static final Log logger = LogFactory.getLog(AttachInfoImporter.class);
	...
	public void executeImport(int userId) {
		...
		for (List<String> groupit : groupitList) {
			...
			if (keyMapper.getMappedKey(KeyMapper.GROUPMULTICHAINFILTER_ID, oldsmartid, userId) != null) {
				continue;
			}
			...
			if (newSmartid != null) {
				keyMapper.addKeyMap(KeyMapper.GROUPMULTICHAINFILTER_ID, oldsmartid, newSmartid, Integer.valueOf(oldUserid));
			}
		}
	...
	public String getTableName() {
		return TableSchemaInfo.GROUPMULTICHAINFILTER;
	}
