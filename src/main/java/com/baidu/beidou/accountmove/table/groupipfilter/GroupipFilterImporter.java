package com.baidu.beidou.accountmove.table.groupipfilter;
...
public class GroupipFilterImporter implements TableImporter{
...
//			String oldPlanid = groupit.get(StringUtil.getIndex("planid", getColumnNameArray())); 
			...
			if (keyMapper.getMappedKey(KeyMapper.GROUPIPFILTER_ID, oldsmartid, userId) != null) {
				continue;
			}
...
//			groupit.set(StringUtil.getIndex("id", getColumnNameArray()), newGenerateUnitId);
			...
			if (newSmartid != null) {
				keyMapper.addKeyMap(KeyMapper.GROUPIPFILTER_ID, oldsmartid, newSmartid, Integer.valueOf(oldUserid));
			}
		}
	...
	public String getTableName() {
		return TableSchemaInfo.GROUPIPFILTER;
	}
