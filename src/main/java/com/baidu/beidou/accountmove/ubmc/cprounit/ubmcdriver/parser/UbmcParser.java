package com.baidu.beidou.accountmove.ubmc.cprounit.ubmcdriver.parser;
...
import com.baidu.beidou.accountmove.ubmc.cprounit.ubmcdriver.material.request.RequestIconMaterial;
import com.baidu.beidou.accountmove.ubmc.cprounit.ubmcdriver.material.request.RequestIconUnitWithData;
import com.baidu.beidou.accountmove.ubmc.cprounit.ubmcdriver.material.request.RequestImageUnitWithData;
import com.baidu.beidou.accountmove.ubmc.cprounit.ubmcdriver.material.request.RequestImageUnitWithMediaId;
import com.baidu.beidou.accountmove.ubmc.cprounit.ubmcdriver.material.request.RequestPreviewImageMaterial;
	...
	public static ResponseBaseMaterial transformToObject(String value) {
		...
		try {
			...
			if (StringUtils.isEmpty(wuliaoTypeStr)) {
				...
				// 如果不包含推广组ID，则为admaker制作的物料；否则为推广组附加信息
			...
			log.error("failed to get wuliaotype from ubmc-value[value=" + value + "]");
			return null;
		}
