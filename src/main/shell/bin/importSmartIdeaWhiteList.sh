...
#@file:importSmartIdeaWhiteList.sh
#@author:dongying
#@version:1.0.0.0
#@brief:import SmartIdea whitelist to database
...
CONF_SH=../conf/importSmartIdeaWhiteList.conf
[ -f "${CONF_SH}" ] && source $CONF_SH || echo "not exist ${CONF_SH} "
...
program=importSmartIdeaWhiteList.sh

LOG_FILE=${LOG_PATH}/importSmartIdeaWhiteList.log
